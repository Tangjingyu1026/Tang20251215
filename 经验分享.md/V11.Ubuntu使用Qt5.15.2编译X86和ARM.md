...
![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps119.jpg) 
...
![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps120.jpg) 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps121.jpg) 

### **4.输入注册的账号，点下一步(Next)，等待登录**![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps122.jpg)

### **5.登录成功开始安装**

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps123.jpg) 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps124.jpg) 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps125.jpg) 

因为前面命令执行：sudo ./qt-online-installer-linux-x64-4.8.1.run ，所以默认路径是 /opt/Qt

默认，然后下一步(Next)

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps126.jpg) 

使用旧版本的Qt把旁边的Archive勾选上，然后点击筛选(Filter)，它就会重新加载，筛选后会出现很多Qt版本，然后选择你需要的版本。

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps127.jpg) 
...
![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps128.jpg) 

注意这里QtCreator，里面的19.0.0目前不要使用，安装以后Qt Creator 19.0.0 版本与Ubuntu 20.04 系统不兼容后期我们进行单独安装Qt Create。

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps129.jpg) 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps130.jpg)![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps131.jpg) 

之后等待安装(时间2小时左右)

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps132.jpg) 

 

点击完成

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps133.jpg) 
...
![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps134.jpg) 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps135.jpg) 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps136.jpg) 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps137.jpg) 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps138.jpg) 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps139.jpg) 
...
![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps140.jpg) 
...
![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps141.jpg) 
...
![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps142.jpg) 

#### **4.2.进入qt-everywhere-src-5.15.2目录给configure 添加执行权限**

chmod +x configure

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps143.jpg) 
...
![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps144.jpg) 
...
![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps145.jpg) 
...
![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps146.jpg) 

## 三、**运行项目**

#### 1. **打开项目**

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps147.jpg) 

 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps148.jpg) 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps149.jpg) 
...
![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps150.jpg) 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps151.jpg) 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps152.jpg) 

#### (2) **添加X86架构qmake QT版****本**

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps153.jpg) 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps154.jpg) 

#### (3) **构建套件进行添加**

   ![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps155.jpg)

#### 1) **构建添加gcc_64套件**

  ![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps156.jpg)

#### 2) **构建添加arm_64套件（如果没有）**

  ![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps157.jpg)

至此我们的套件添加完成接下来进行编译项目并进行构建

 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps158.jpg) 

#### 3. **编译构建效果**

 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps159.jpg) 

#### 4. **编译 x86 架构时候，报错信息。**

如果遇到了报错的话，qt.qpa.plugin: Could not load the Qt platform plugin "xcb" in "" even though it was found.  则需要安装依赖 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps160.jpg) 
...
![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps161.jpg) 
...
![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps162.jpg) 
...
![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps163.jpg) 
...
![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps164.jpg) 

### **4打开我们项目所在的位置**

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps165.jpg) 

进入build目录创建一个Qt打包的程序，放到我们创建的文件夹cutecom里，并将我们使用的cutecom进行

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps166.jpg) 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps167.jpg) 

 

把打包的运行程序cutecom放到我们创建的cutecom文件夹里

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps168.jpg) 

打开cutecom的终端执行以下命令

/usr/local/bin/linuxdeployqt-x86 cutecom -appimage

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps169.jpg) 

最终文件夹cutecom的内容

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps170.jpg) 
...
![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps171.jpg) 

### 2. **将编译好的 build 可执行文件 拷贝到 对应架构中 x86** 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps172.jpg) 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps173.jpg) 

 

### 3. **连接使用485协议进行通信**

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps174.jpg) 

### 4. **发送指令接收指令，通信成功**

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps175.jpg) 

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps176.jpg) 

###  

![img](./V11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps177.jpg) 
