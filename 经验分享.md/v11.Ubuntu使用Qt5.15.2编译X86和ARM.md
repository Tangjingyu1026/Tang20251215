...
![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps178.jpg) 
...
![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps179.jpg) 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps180.jpg) 

### **4.输入注册的账号，点下一步(Next)，等待登录**![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps181.jpg)

### **5.登录成功开始安装**

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps182.jpg) 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps183.jpg) 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps184.jpg) 

因为前面命令执行：sudo ./qt-online-installer-linux-x64-4.8.1.run ，所以默认路径是 /opt/Qt

默认，然后下一步(Next)

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps185.jpg) 

使用旧版本的Qt把旁边的Archive勾选上，然后点击筛选(Filter)，它就会重新加载，筛选后会出现很多Qt版本，然后选择你需要的版本。

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps186.jpg) 
...
![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps187.jpg) 

注意这里QtCreator，里面的19.0.0目前不要使用，安装以后Qt Creator 19.0.0 版本与Ubuntu 20.04 系统不兼容后期我们进行单独安装Qt Create。

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps188.jpg) 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps189.jpg)![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps190.jpg) 

之后等待安装(时间2小时左右)

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps191.jpg) 

 

点击完成

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps192.jpg) 
...
![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps193.jpg) 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps194.jpg) 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps195.jpg) 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps196.jpg) 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps197.jpg) 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps198.jpg) 
...
![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps199.jpg) 
...
![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps200.jpg) 
...
![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps201.jpg) 

#### **4.2.进入qt-everywhere-src-5.15.2目录给configure 添加执行权限**

chmod +x configure

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps202.jpg) 
...
![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps203.jpg) 
...
![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps204.jpg) 
...
![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps205.jpg) 

## 三、**运行项目**

#### 1. **打开项目**

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps206.jpg) 

 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps207.jpg) 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps208.jpg) 
...
![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps209.jpg) 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps210.jpg) 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps211.jpg) 

#### (2) **添加X86架构qmake QT版****本**

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps212.jpg) 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps213.jpg) 

#### (3) **构建套件进行添加**

   ![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps214.jpg)

#### 1) **构建添加gcc_64套件**

  ![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps215.jpg)

#### 2) **构建添加arm_64套件（如果没有）**

  ![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps216.jpg)

至此我们的套件添加完成接下来进行编译项目并进行构建

 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps217.jpg) 

#### 3. **编译构建效果**

 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps218.jpg) 

#### 4. **编译 x86 架构时候，报错信息。**

如果遇到了报错的话，qt.qpa.plugin: Could not load the Qt platform plugin "xcb" in "" even though it was found.  则需要安装依赖 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps219.jpg) 
...
![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps220.jpg) 
...
![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps221.jpg) 
...
![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps222.jpg) 
...
![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps223.jpg) 

### **4打开我们项目所在的位置**

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps224.jpg) 

进入build目录创建一个Qt打包的程序，放到我们创建的文件夹cutecom里，并将我们使用的cutecom进行

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps225.jpg) 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps226.jpg) 

 

把打包的运行程序cutecom放到我们创建的cutecom文件夹里

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps227.jpg) 

打开cutecom的终端执行以下命令

/usr/local/bin/linuxdeployqt-x86 cutecom -appimage

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps228.jpg) 

最终文件夹cutecom的内容

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps229.jpg) 
...
![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps230.jpg) 

### 2. **将编译好的 build 可执行文件 拷贝到 对应架构中 x86** 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps231.jpg) 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps232.jpg) 

 

### 3. **连接使用485协议进行通信**

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps233.jpg) 

### 4. **发送指令接收指令，通信成功**

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps234.jpg) 

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps235.jpg) 

###  

![img](./v11.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps236.jpg) 
