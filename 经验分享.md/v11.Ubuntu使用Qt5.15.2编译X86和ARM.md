...
![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps314.jpg) 
...
![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps315.jpg) 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps316.jpg) 

### **4.输入注册的账号，点下一步(Next)，等待登录**![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps317.jpg)

### **5.登录成功开始安装**

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps318.jpg) 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps319.jpg) 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps320.jpg) 

因为前面命令执行：sudo ./qt-online-installer-linux-x64-4.8.1.run ，所以默认路径是 /opt/Qt

默认，然后下一步(Next)

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps321.jpg) 

使用旧版本的Qt把旁边的Archive勾选上，然后点击筛选(Filter)，它就会重新加载，筛选后会出现很多Qt版本，然后选择你需要的版本。

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps322.jpg) 
...
![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps323.jpg) 

注意这里QtCreator，里面的19.0.0目前不要使用，安装以后Qt Creator 19.0.0 版本与Ubuntu 20.04 系统不兼容后期我们进行单独安装Qt Create。

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps324.jpg) 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps325.jpg)![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps326.jpg) 

之后等待安装(时间2小时左右)

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps327.jpg) 

 

点击完成

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps328.jpg) 
...
![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps329.jpg) 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps330.jpg) 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps331.jpg) 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps332.jpg) 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps333.jpg) 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps334.jpg) 
...
![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps335.jpg) 
...
![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps336.jpg) 
...
![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps337.jpg) 

#### **4.2.进入qt-everywhere-src-5.15.2目录给configure 添加执行权限**

chmod +x configure

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps338.jpg) 
...
![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps339.jpg) 
...
![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps340.jpg) 
...
![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps341.jpg) 

## 三、**运行项目**

#### 1. **打开项目**

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps342.jpg) 

 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps343.jpg) 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps344.jpg) 
...
![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps345.jpg) 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps346.jpg) 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps347.jpg) 

#### (2) **添加X86架构qmake QT版****本**

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps348.jpg) 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps349.jpg) 

#### (3) **构建套件进行添加**

   ![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps350.jpg)

#### 1) **构建添加gcc_64套件**

  ![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps351.jpg)

#### 2) **构建添加arm_64套件（如果没有）**

  ![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps352.jpg)

至此我们的套件添加完成接下来进行编译项目并进行构建

 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps353.jpg) 

#### 3. **编译构建效果**

 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps354.jpg) 

#### 4. **编译 x86 架构时候，报错信息。**

如果遇到了报错的话，qt.qpa.plugin: Could not load the Qt platform plugin "xcb" in "" even though it was found.  则需要安装依赖 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps355.jpg) 
...
![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps356.jpg) 
...
![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps357.jpg) 
...
![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps358.jpg) 
...
![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps359.jpg) 

### **4打开我们项目所在的位置**

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps360.jpg) 

进入build目录创建一个Qt打包的程序，放到我们创建的文件夹cutecom里，并将我们使用的cutecom进行

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps361.jpg) 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps362.jpg) 

 

把打包的运行程序cutecom放到我们创建的cutecom文件夹里

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps363.jpg) 

打开cutecom的终端执行以下命令

/usr/local/bin/linuxdeployqt-x86 cutecom -appimage

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps364.jpg) 

最终文件夹cutecom的内容

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps365.jpg) 
...
![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps366.jpg) 

### 2. **将编译好的 build 可执行文件 拷贝到 对应架构中 x86** 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps367.jpg) 

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps368.jpg) 

 

### 3. **连接使用485协议进行通信**

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps369.jpg) 

### 4. **发送指令接收指令，通信成功**

![img](./v10.Ubuntu使用Qt5.15.2编译X86和ARM.assets/wps370.jpg) 
